{application,chatterbox,
             [{description,"chatterbox library for http2"},
              ...
              {modules, ['chatterbox','chatterbox_ranch_protocol','chatterbox_static_content_handler','chatterbox_static_stream','chatterbox_sup','h2_client','h2_connection','h2_frame','h2_frame_continuation','h2_frame_data','h2_frame_goaway','h2_frame_headers','h2_frame_ping','h2_frame_priority','h2_frame_push_promise','h2_frame_rst_stream','h2_frame_settings','h2_frame_window_update','h2_padding','h2_settings','h2_stream','h2_stream_set','sock']}]}.
