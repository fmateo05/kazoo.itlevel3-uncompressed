{application,gen_smtp,
             [{description,"A generic Erlang SMTP server/client framework"},
              {vsn,"0.14.0"},
              {modules, ['binstr','gen_smtp_application','gen_smtp_client','gen_smtp_server','gen_smtp_server_session','mimemail','smtp_rfc822_parse','smtp_server_example','smtp_socket','smtp_util']},
